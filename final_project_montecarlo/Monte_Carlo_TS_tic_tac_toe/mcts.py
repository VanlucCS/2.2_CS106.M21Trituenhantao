...
#Below we demonstrate the Monte Carlo Tree Search code in Python
#Define Monte Carlo Tree Search class
class TreeNode(object):
    ...
    """
    SELECTION
    The idea is to keep selecting best child nodes until we reach the leaf node of the tree 
    A good way to select such a child node is to use UCT (Upper Confidence Bound applied to trees) formula:
    """
