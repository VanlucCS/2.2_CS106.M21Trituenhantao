...
from human_play_UI import Tic_Tac_Toe_UI
...
parser.add_argument("--game",
                    ...
                    type=int,
                    default=CFG.game)
parser.add_argument("--gameUI_tic_tac_toe",
                    help="play game with UI we make.",
                    dest="gameUI_tic_tac_toe",
                    type=int,
                    default=CFG.gameUI_tic_tac_toe)
...
if __name__ == '__main__':
    ...
    CFG.gameUI_tic_tac_toe = arguments.gameUI_tic_tac_toe
    ...
    if CFG.human_play and CFG.game ==1:
        human_play = HumanPlay(game, net)
        human_play.play()
    elif CFG.human_play and CFG.game == 0 and CFG.gameUI_tic_tac_toe == 0:
        human_play =HumanPlay(game, net)
        human_play.play()
    elif CFG.human_play and CFG.game == 0 and CFG.gameUI_tic_tac_toe == 1:
        human_play =Tic_Tac_Toe_UI(game, net)
        human_play.mainloop()
    else:
